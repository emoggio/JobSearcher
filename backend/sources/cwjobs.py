"""CWJobs scraper using httpx + BeautifulSoup."""
import urllib.parse
...
async def scrape(params: dict) -> list[dict]:
    ...
    url = f"https://www.cwjobs.co.uk/jobs/{keywords}/in-{location}?postedwithin=30"
    ...
    for card in cards[:50]:
        try:
            ...
            jobs.append({
                ...
                "url": "https://www.cwjobs.co.uk" + link["href"] if link else None,
                "source": "cwjobs",
